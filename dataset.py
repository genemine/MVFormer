...
OPENML_DATACONFIG = {
    './data/clinvar_2022_missense': {
        'bin': ["BayesDel_addAF_pred","BayesDel_noAF_pred",
                 "ClinPred_pred","DEOGEN2_pred","FATHMM_pred","LIST_S2_pred","M_CAP_pred","MetaLR_pred","MetaRNN_pred",
                 "MetaSVM_pred","MutationAssessor_pred","MutationTaster_pred","PROVEAN_pred",
                 "PrimateAI_pred","SIFT4G_pred","fathmm_MKL_coding_pred"],
        "cat": ["DOMAINS",
                "Ensembl-Gene-ID", "Ensembl-Protein-ID",
                "Ensembl-Transcript-ID", "Uniprot-Accession"],
        "num": ["kGp3_AF","ExAC_AF","gnomAD_exomes_AF","AF","gnomAD_AF","MAX_AF","EA_AF",
                'BayesDel_addAF_rankscore','BayesDel_noAF_rankscore','CADD_raw_rankscore','CADD_raw_rankscore_hg19','ClinPred_rankscore', 'DANN_rankscore', 'DEOGEN2_rankscore', 'Eigen_PC_raw_coding_rankscore',
                 'Eigen_raw_coding_rankscore', 'FATHMM_converted_rankscore','LIST_S2_rankscore', 'MPC_rankscore','MetaLR_rankscore', 'MetaRNN_rankscore', 'MetaSVM_rankscore',
                 'MutationAssessor_rankscore', 'MutationTaster_converted_rankscore', 'PROVEAN_converted_rankscore','Polyphen2_HDIV_rankscore', 'Polyphen2_HVAR_rankscore','PrimateAI_rankscore', 'REVEL_rankscore',
                 'SIFT4G_converted_rankscore','SIFT_converted_rankscore', 'VEST4_rankscore','fathmm_MKL_coding_rankscore', 'fathmm_XF_coding_rankscore','GenoCanyon_rankscore',
                 'phastCons100way_vertebrate_rankscore','phyloP100way_vertebrate_rankscore','GERP_RS_rankscore'],
        "cols": ["BayesDel_addAF_pred","BayesDel_noAF_pred",
                 "ClinPred_pred","DEOGEN2_pred","FATHMM_pred","LIST_S2_pred","M_CAP_pred","MetaLR_pred","MetaRNN_pred",
                 "MetaSVM_pred","MutationAssessor_pred","MutationTaster_pred","PROVEAN_pred",
                 "PrimateAI_pred","SIFT4G_pred","fathmm_MKL_coding_pred",
                 "DOMAINS",
                "Ensembl-Gene-ID", "Ensembl-Protein-ID",
                "Ensembl-Transcript-ID", "Uniprot-Accession",
                "kGp3_AF","ExAC_AF","gnomAD_exomes_AF","AF","gnomAD_AF","MAX_AF","EA_AF",'BayesDel_addAF_rankscore','BayesDel_noAF_rankscore','CADD_raw_rankscore',
                 'CADD_raw_rankscore_hg19','ClinPred_rankscore', 'DANN_rankscore', 'DEOGEN2_rankscore', 'Eigen_PC_raw_coding_rankscore',
                 'Eigen_raw_coding_rankscore', 'FATHMM_converted_rankscore', 'LIST_S2_rankscore',
                 ...
                 'fathmm_MKL_coding_rankscore', 'fathmm_XF_coding_rankscore','GenoCanyon_rankscore',
                 'phastCons100way_vertebrate_rankscore','phyloP100way_vertebrate_rankscore','GERP_RS_rankscore'],
        "binary_indicator": ["1", "yes", "true", "positive", "t", "y"],
    },
    './data/cancer_discover': {
        'bin': ["BayesDel_addAF_pred","BayesDel_noAF_pred",
                 "ClinPred_pred","DEOGEN2_pred","FATHMM_pred","LIST_S2_pred","M_CAP_pred","MetaLR_pred","MetaRNN_pred",
                 "MetaSVM_pred","MutationAssessor_pred","MutationTaster_pred","PROVEAN_pred",
                 "PrimateAI_pred","SIFT4G_pred","fathmm_MKL_coding_pred"],
...
def load_single_data(dataname, dataset_config=None, encode_cat=False, data_cut=None, seed=123):
    ...
    if os.path.exists(dataname):
        ...
        if dataset_config is not None:
            ...
            if 'bin' in dataset_config:
                bin_cols=[]
                for el in dataset_config['bin']:
                    bin_cols.append(el.lower())
                # bin_cols = dataset_config['bin']
            
            if 'cat' in dataset_config:
                cat_cols = []
                for el in dataset_config['cat']:
                    cat_cols.append(el.lower())
                # cat_cols = dataset_config['cat']

            if 'num' in dataset_config:
                num_cols = []
                for el in dataset_config['num']:
                    num_cols.append(el.lower())
    ...
    if data_split_idx is not None:
        ...
        train_dataset, test_dataset, y_train, y_test = train_test_split(X, y, test_size=0.1, random_state=seed, stratify=y, shuffle=True)
